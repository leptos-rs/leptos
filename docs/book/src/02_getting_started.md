...
>
> To use nightly Rust, you can either change for all your rust projects by running
>
> ```bash
...
> ```
>
> or only for your actual project
>
> > ```bash
> rustup toolchain install nightly
> cd <into your actual development folder>
> rustup override set nightly
> ```
>
> For details kindly refer to https://doc.rust-lang.org/book/appendix-07-nightly-rust.html
> 
