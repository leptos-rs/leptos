...
pub(crate) fn typed_builder_opts<'a>(
    is_optional: bool,
...
// -------------------------------------------------------------------
// Prop documentation generation (shared by components and slots)
// -------------------------------------------------------------------

/// Controls the output format of prop documentation.
#[derive(Clone, Copy)]
pub(crate) enum PropDocStyle {
...
pub(crate) struct PropDocInput<'a> {
    pub docs: &'a Docs,
    pub name: &'a Ident,
    pub ty: &'a Type,
...
/// Generates grouped prop documentation with required and
/// optional sections.
pub(crate) fn generate_prop_docs(props: &[PropDocInput]) -> TokenStream {
