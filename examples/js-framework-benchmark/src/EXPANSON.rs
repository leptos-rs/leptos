...
fn x() {
    {
        leptos::leptos_dom::html::div(cx).attr("class",(cx,"container")).child((cx,leptos::leptos_dom::html::div(cx).attr("class",(cx,"jumbotron")).child((cx,leptos::leptos_dom::html::div(cx).attr("class",(cx,"row")).child((cx,leptos::leptos_dom::html::div(cx).attr("class",(cx,"col-md-6")).child((cx,leptos::leptos_dom::html::h1(cx).child("Leptos"))))).child((cx,leptos::leptos_dom::html::div(cx).attr("class",(cx,"col-md-6")).child((cx,leptos::leptos_dom::html::div(cx).attr("class",(cx,"row")).child((cx,Button(cx, ::leptos::component_props_builder(&Button).id(#[allow(unused_braces)]
"run").text(#[allow(unused_braces)]
"Create 1,000 rows").build()).into_view(cx).on(::leptos::leptos_dom::ev::undelegated(::leptos::leptos_dom::ev::click),run))).child((cx,Button(cx, ::leptos::component_props_builder(&Button).id(#[allow(unused_braces)]
...
"Swap Rows").build()).into_view(cx).on(::leptos::leptos_dom::ev::undelegated(::leptos::leptos_dom::ev::click),swap_rows))))))))))).child((cx,leptos::leptos_dom::html::table(cx).attr("class",(cx,"table table-hover table-striped test-data")).child((cx,leptos::leptos_dom::html::tbody(cx).child((cx,For(cx, ::leptos::component_props_builder(&For).each(#[allow(unused_braces)]
{
  data
...
move|cx,row:RowData|{
  ...
  {
    const TEMPLATE_2ee0e610b17040de9cbc6f19fd9864dd:std::thread::LocalKey<leptos::web_sys::HtmlTemplateElement>  = {
      #[inline]
    ...
    ;
    ;
    let root = TEMPLATE_2ee0e610b17040de9cbc6f19fd9864dd.with(|tpl|tpl.content().clone_node_with_deep(true)).unwrap().first_child().unwrap();
    let _el1 = "tr";
...
}).build()))))))).child((cx,leptos::leptos_dom::html::span(cx).attr("class",(cx,"preloadicon glyphicon glyphicon-remove")).attr("aria-hidden",(cx,"true")))).with_view_marker("-0")
    }
}
