...
//! - `nightly` By default, Leptos requires `nightly` Rust, which is what allows the ergonomics
//!   of calling signals as functions. Disable this feature to support `stable` Rust.
//!
